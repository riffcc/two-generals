...
\begin{enumerate}
    ...
    \item Formal proofs of safety, liveness, and validity in Lean 4 (\S\ref{sec:proofs})
...
The Lean 4 formalization (\texttt{lean4/}) provides machine-verified guarantees with \textbf{zero \texttt{sorry} statements}---the proofs are complete with no deferred obligations. The verification includes 50+ theorems across 13 layers, with extensive axiom reduction through Mathlib integration:
...
\textbf{Lightweight TGP} & \texttt{LightweightTGP.lean} & \textbf{19} & \textbf{15 (channel/crash)} \\
