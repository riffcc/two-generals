...
# TGP-Piper LAN Benchmark
# Measures performance on local area network
...
REMOTE_HOST="${1:-$TGP_BENCH_LAN_HOST}"
RUN_ID="${2:-lan-$(generate_timestamp)}"
FILE_SIZE="${TGP_BENCH_FILE_SIZE_LAN}"
RUNS="${TGP_BENCH_RUNS}"
WARMUP_RUNS="${TGP_BENCH_WARMUP_RUNS}"

# Create data directory
DATA_DIR="$(create_data_dir "lan" "$RUN_ID")"
